		...
		<div class="container clearfix">
		  ...
		  <div class="row">
			...
			<div class="col-md-9">
				...
				$jobsCatategory = json_decode($jobsCatategory, true);
				foreach($jobsCatategory as $post): ?>
				<div class="media card">
				  <!-- <div class="media-left">
				  					<a href="<?=$baseUrl;?>/jobs/<?=Post::slugify($post['posisi'].'-'.$post['vacid']); ?>">
				  					  <img class="media-object" src="<?=$templateUrl;?>img/8e692fb9d3514dced645f45ff53b8ada.png">
				  					</a>
				  </div> -->
